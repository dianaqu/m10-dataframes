...
salaries.2014 <- runif(100, 2000, 10000)
...
salaries[salaries$got.raise == FALSE, 'raise']
salaries$raise[salaries$got.raise == FALSE]

# Is that what you expected them to lose?

### Double Bonus (no answer given) ###
mean(salaries$raise[salaries$got.raise == FALSE])
